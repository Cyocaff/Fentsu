...
Fentsu uses a small python server to just serve the static files and the base.html
this server checks wether an user is making a request from inside the page or is loading
